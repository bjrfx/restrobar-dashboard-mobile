...
const Settings = ({ darkMode, setDarkMode, transitionsEnabled, setTransitionsEnabled }) => {
  ...
  return (
    <Box sx={{ padding: 3, maxWidth: 600, margin: 'auto', position: 'relative', height: '80vh' }}>
      {auth.currentUser ? (
        <Button
          variant="contained"
          color="primary"
      ...
      <p style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)', textAlign: 'center'}}>Version 0.1.2</p>
    </Box>
  );
};
